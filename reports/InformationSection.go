...
func InformationSection (f *excelize.File, sheet, date, time string){
	...
	ApplyFontStyleText("J8", "Bryan Freire Macías", f)
	ApplyFontStyleSubtitle("P8", "Capitán:", f)
	ApplyFontStyleText("R8", "Bryan Freire", f)
	ApplyFontStyleSubtitle("T8", "Cédula:", f)
	ApplyFontStyleText("V8", "2000069308", f)
	...
	ApplyFontStyleText("J9", "2000069308", f)
	ApplyFontStyleSubtitle("L9", "Teléfono:", f)
	ApplyFontStyleText("N9", "0939946283", f)
	ApplyFontStyleSubtitle("P9", "Marinero 1:", f)
	ApplyFontStyleText("R9", "Jorge Torres", f)
	ApplyFontStyleSubtitle("T9", "Cédula:", f)
	ApplyFontStyleText("V9", "2000073136", f)
